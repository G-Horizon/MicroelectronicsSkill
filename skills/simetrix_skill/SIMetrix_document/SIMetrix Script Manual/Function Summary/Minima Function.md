...
The function returns the XY values for each minimum point. The X-values are returned as the vector's reference (see  [Vector References](scriptlanguage_accessingsimulationdata.htm#scriptlanguage_accessingsimulationdata__vectorreferences)  ).

|  |  |  |
| --- | --- | --- |
| [▲Function Summary▲](functionsummary.htm#functionsummary__func_minima) | | |
| [◄ minidx](func_minidx.htm) |  | [Minimum ▶](func_minimum.htm) |
