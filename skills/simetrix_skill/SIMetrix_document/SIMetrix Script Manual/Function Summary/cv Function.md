...
This function is identical to  [GetCurveVector](func_getcurvevector.htm)  and is convenient in situations where a short expression is desirable.
...
|  |  |  |
| --- | --- | --- |
| [▲Function Summary▲](functionsummary.htm#functionsummary__func_cv) | | |
| [◄ CurveFitLogY](func_curvefitlogy.htm) |  | [CyclePeriod ▶](func_cycleperiod.htm) |
