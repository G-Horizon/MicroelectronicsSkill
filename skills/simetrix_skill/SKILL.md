...
**`./SIMPLIS&SIMetrix文档/SIMetrix Script Manual`**
...
- **Commands** (for performing actions, such as `Run`, `OpenSchem`, `Close`):
  Read `./SIMPLIS&SIMetrix文档/SIMetrix Script Manual/Command Summary.md`
  
- **Functions** (for processing data, retrieving statuses, evaluating logic):
  Read `./SIMPLIS&SIMetrix文档/SIMetrix Script Manual/Function Summary.md`
...
- For **Commands**, look in the `Command Summary` folder.
  *Example: If you want to use the `Abort` command, read:*
  `./SIMPLIS&SIMetrix文档/SIMetrix Script Manual/Command Summary/Abort Command.md`

- For **Functions**, look in the `Function Summary` folder.
  *Example: If you need to use the `Abs` function, read:*
  `./SIMPLIS&SIMetrix文档/SIMetrix Script Manual/Function Summary/Abs Function.md`
...
2. **Use Search**: If the summary files are long, use `grep_search` to look for keywords (e.g., "export", "netlist", "zoom") within the `./SIMPLIS&SIMetrix文档/SIMetrix Script Manual` directory.
